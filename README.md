...
- `Space`: hop
- Left mouse button (hold): mine the highlighted block
...
Mining is held rather than instant: the aimed block grows a crack overlay as you hold, then breaks in a burst of tinted debris. The center reticle is hidden on touch, where the finger is the aim; pointer devices keep it.
